...
namespace PCBsetup
{
    public class clsTools
    {
        ...
        private string cAppVersion = "1.4.3";
        private string cESPfirmware = "23-Apr-2025";
        private string cNanoFirmware = "23-Apr-2025";
        private string cPropertiesFile = "";
        private string cSettingsDir = "";
        private string cSwitchboxFirmware = "12-Apr-2025";
        private string cTeensyAutoSteerFirmware = "10-Mar-2025";
        private string cTeensyRateVersion = "23-Apr-2025";
        private string cVersionDate = "23-Apr-2025";
