...
namespace PCBsetup
{
    public class clsTools
    {
        ...
        private string cAppVersion = "1.1.9";
        private string cESPfirmware = "20-Mar-2024";
        private string cNanoFirmware = "20-Mar-2024";
        ...
        private string cTeensyRateVersion = "20-Mar-2024";
